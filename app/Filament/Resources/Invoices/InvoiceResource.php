...
class InvoiceResource extends Resource
{
    ...
    public static function form(Schema $schema): Schema
    {
        return $schema->components([
            ...
            Select::make('customer_id')->relationship('customer', 'name')->searchable()->preload()->disabledOn('edit'),
            Select::make('partner_id')->relationship('partner', 'name')->searchable()->preload()->disabledOn('edit'),
