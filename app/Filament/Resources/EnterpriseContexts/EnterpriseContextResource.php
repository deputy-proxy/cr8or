...
class EnterpriseContextResource extends Resource {
 ...
 public static function getPages(): array { return ['index'=>ListEnterpriseContexts::route('/'),'create'=>CreateEnterpriseContext::route('/create'),'edit'=>EditEnterpriseContext::route('/{record}/edit')]; }
}