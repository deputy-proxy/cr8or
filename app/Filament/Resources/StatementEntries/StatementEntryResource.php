...
class StatementEntryResource extends Resource
{
    ...
    public static function form(Schema $schema): Schema
    {
        return $schema->components([
            ...
            Select::make('statement_id')->relationship('statement', 'name')->searchable()->preload()->disabledOn('edit'),
            Select::make('financial_account_id')->relationship('financialAccount', 'name')->searchable()->preload()->disabledOn('edit'),
            Select::make('transaction_id')->relationship('transaction', 'name')->searchable()->preload(),
