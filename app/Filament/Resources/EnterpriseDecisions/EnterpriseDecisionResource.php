...
class EnterpriseDecisionResource extends Resource {
 ...
 public static function table(Table $table): Table { return $table->columns([TextColumn::make('title')->searchable(),TextColumn::make('enterprise.name')->searchable(),TextColumn::make('actor_name')->searchable(),TextColumn::make('decided_at')->dateTime(),])->recordActions([\Filament\Actions\EditAction::make(),]); }
 ...
 public static function getPages(): array { return ['index'=>ListEnterpriseDecisions::route('/'),'create'=>CreateEnterpriseDecision::route('/create'),'edit'=>EditEnterpriseDecision::route('/{record}/edit')]; }
}