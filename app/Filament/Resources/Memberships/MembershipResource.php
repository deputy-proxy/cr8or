...
class MembershipResource extends Resource
{
    ...
    {
        return $table->columns([TextColumn::make('user.name')->searchable()->sortable(), TextColumn::make('organization.name')->searchable()->sortable(), TextColumn::make('role')->badge()])->recordActions([\Filament\Actions\EditAction::make()]);
    }
    ...
    {
        return ['index' => ListMemberships::route('/'), 'create' => CreateMembership::route('/create'), 'edit' => EditMembership::route('/{record}/edit')];
    }
}