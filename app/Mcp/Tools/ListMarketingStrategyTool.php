...
#[Name('list-marketing-strategies')]
#[Description('Discover authorized marketing strategy resources used by campaign planning.')]
class ListMarketingStrategyTool extends DiscoveryListTool
{
    protected static function modelClass(): string
    {
        return MarketingStrategy::class;
    }
