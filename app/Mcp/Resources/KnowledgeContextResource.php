...
#[Description('Authorized knowledge context for the requested enterprise.')]
class KnowledgeContextResource extends Resource implements HasUriTemplate
{
    public function uriTemplate(): UriTemplate
    {
        return new UriTemplate('cr8or://enterprises/{enterprise}/knowledge');
    }
